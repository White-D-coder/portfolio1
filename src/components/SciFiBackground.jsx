        ...
        <div className={`relative w-full h-full pointer-events-none select-none overflow-hidden ${className}`}>
            ...
            >
                ...
                <g className="opacity-30">
                    ...
                    <circle cx="400" cy="150" r="3" fill="white" className="opacity-50" />
                    <motion.circle
                    ...
                    <circle cx="1500" cy="850" r="3" fill="white" className="opacity-50" />
                    <motion.circle
                        cx="0" cy="0" r="2" fill="white"
                        animate={{ offsetDistance: ["0%", "100%"] }}
                ...
                <g transform="translate(960, 540)">
                    ...
                    <motion.ellipse
                        ...
                        fill="none" stroke="white" strokeWidth="1" strokeOpacity="0.2"
                        animate={{ rotate: 360 }}
